...
TBRW = readmatrix("logs/log_20-11-2025_13_50_45_V_BRW_1000ms_0.524rad_0.55len_1.57rads_SEED7.csv");
n = 5000; %Pick every n points

XBRW = TBRW(1:n:end,1);
YBRW = TBRW(1:n:end,7);
YBRW_b = movmean(YBRW,5);
plot(XBRW, YBRW_b, 'r-', 'LineWidth', 1);
...
legend('Velocity Bounded Random Walk (15 RPM)');
